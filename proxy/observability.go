...
func (o *transformObserver) RecordWarning(ctx context.Context, provider string, source, target protocol.Format, warning protocol.Warning) {
...
func (o *transformObserver) RecordLoss(ctx context.Context, provider string, source, target protocol.Format, loss protocol.SemanticLoss) {
	attributes := transformAttributes(provider, source, target)
...
func transformAttributes(provider string, source, target protocol.Format) []attribute.KeyValue {
