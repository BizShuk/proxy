...
`entity`：`anthropic-messages__antigravity`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/antigravity/claude/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/antigravity/claude/init.go) — 顯式 translator registry pair
