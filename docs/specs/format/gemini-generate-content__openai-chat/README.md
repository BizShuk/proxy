...
`entity`：`gemini-generate-content__openai-chat`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/openai/gemini/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/openai/gemini/init.go) — 顯式 translator registry pair
