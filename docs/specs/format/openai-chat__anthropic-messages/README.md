...
`entity`：`openai-chat__anthropic-messages`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/claude/openai/chat-completions/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/claude/openai/chat-completions/init.go) — 顯式 translator registry pair
