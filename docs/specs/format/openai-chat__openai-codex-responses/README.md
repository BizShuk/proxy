# OpenAI Chat Completions → OpenAI Codex Responses

`entity`：`openai-chat__openai-codex-responses`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/codex/openai/chat-completions/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/codex/openai/chat-completions/init.go) — 顯式 translator registry pair
