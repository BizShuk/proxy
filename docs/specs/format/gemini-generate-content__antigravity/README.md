# Gemini GenerateContent → Antigravity

`entity`：`gemini-generate-content__antigravity`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/antigravity/gemini/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/antigravity/gemini/init.go) — 顯式 translator registry pair
