...
`entity`：`anthropic-messages__gemini-generate-content`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/gemini/claude/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/gemini/claude/init.go) — 顯式 translator registry pair
