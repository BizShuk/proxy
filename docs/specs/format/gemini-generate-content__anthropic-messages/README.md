...
`entity`：`gemini-generate-content__anthropic-messages`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/claude/gemini/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/claude/gemini/init.go) — 顯式 translator registry pair
