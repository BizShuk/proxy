...
`entity`：`anthropic-messages__openai-chat`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/openai/claude/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/openai/claude/init.go) — 顯式 translator registry pair
