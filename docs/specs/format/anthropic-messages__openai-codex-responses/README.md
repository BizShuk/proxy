# Anthropic Messages → OpenAI Codex Responses

`entity`：`anthropic-messages__openai-codex-responses`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/codex/claude/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/codex/claude/init.go) — 顯式 translator registry pair
