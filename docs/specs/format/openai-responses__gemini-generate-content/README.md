...
`entity`：`openai-responses__gemini-generate-content`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/gemini/openai/responses/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/gemini/openai/responses/init.go) — 顯式 translator registry pair
