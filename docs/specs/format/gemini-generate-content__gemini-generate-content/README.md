...
`entity`：`gemini-generate-content__gemini-generate-content`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/gemini/gemini/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/gemini/gemini/init.go) — 顯式 translator registry pair
