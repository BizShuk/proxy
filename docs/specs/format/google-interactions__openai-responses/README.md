# Google Interactions → OpenAI Responses

`entity`：`google-interactions__openai-responses`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/openai/interactions/responses/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/openai/interactions/responses/init.go) — 顯式 translator registry pair
