# Anthropic Messages → Google Interactions

`entity`：`anthropic-messages__google-interactions`
...
- `CLIProxyAPI main@411d7d41`：[internal/translator/interactions/claude/init.go](../../../../../../tmp/CLIProxyAPI/internal/translator/interactions/claude/init.go) — 顯式 translator registry pair
