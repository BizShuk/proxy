...
func TestAnthropicToChatRejectsUnsupportedContentBlock(t *testing.T) {
	...
	_, err := AnthropicToChatRequest(context.Background(), model.RequestEnvelope{Model: "gpt", Body: body})
...
func TestChatToAnthropicRejectsRemoteImage(t *testing.T) {
	...
	_, err := ChatToAnthropicRequest(context.Background(), model.RequestEnvelope{Model: "claude", Body: body})
