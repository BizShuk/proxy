...
func NewResponsesToAnthropicStream(exchange protocol.Exchange) (StreamTransform, error) {
...
func (s *responsesToAnthropicStream) Push(ctx context.Context, frame protocol.SSEFrame) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) Close(ctx context.Context) ([]protocol.SSEFrame, error) {
	if err := ctx.Err(); err != nil {
		return nil, err
	}
	if !s.terminal {
...
func (s *responsesToAnthropicStream) ensureMessageStart() ([]protocol.SSEFrame, error) {
	if s.started {
		return nil, nil
	}
	s.started = true
...
func (s *responsesToAnthropicStream) pushReasoning(delta string) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) addOutputItem(item responses.OutputItem) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) pushText(itemID, delta string) ([]protocol.SSEFrame, error) {
	output, err := s.ensureMessageStart()
	if err != nil {
		return nil, err
	}
...
func (s *responsesToAnthropicStream) pushArguments(itemID, callID, delta string) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) finishArguments(itemID, callID, arguments string) ([]protocol.SSEFrame, error) {
	block, err := s.resolveTool(itemID, callID)
	if err != nil {
		return nil, err
	}
...
func (s *responsesToAnthropicStream) finishOutputItem(item responses.OutputItem) ([]protocol.SSEFrame, error) {
	if item.Type == "function_call" {
...
func (s *responsesToAnthropicStream) complete(response responses.Response) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) fail(response responses.Response) ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) closeNarrativeBlocks() ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) closeActiveTextBlocks() ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) closeAllBlocks() ([]protocol.SSEFrame, error) {
...
func (s *responsesToAnthropicStream) closeBlock(block *responsesToAnthropicBlock) ([]protocol.SSEFrame, error) {
	if block == nil || !block.open {
		return nil, nil
	}
...
func closeResponsesAnthropicBlocks(blocks []*responsesToAnthropicBlock) ([]protocol.SSEFrame, error) {
	sort.Slice(blocks, func(left, right int) bool { return blocks[left].index < blocks[right].index })
	output := make([]protocol.SSEFrame, 0, len(blocks))
...
func anthropicBlockStart(index int, block anthropic.Content) (protocol.SSEFrame, error) {
...
func NewAnthropicToResponsesStream(exchange protocol.Exchange) (StreamTransform, error) {
	if exchange.NewID == nil {
...
func (s *anthropicToResponsesStream) Push(ctx context.Context, frame protocol.SSEFrame) ([]protocol.SSEFrame, error) {
	if err := ctx.Err(); err != nil {
		return nil, err
	}
	if s.terminal {
...
func (s *anthropicToResponsesStream) Close(ctx context.Context) ([]protocol.SSEFrame, error) {
	if err := ctx.Err(); err != nil {
		return nil, err
	}
	if !s.terminal {
...
func (s *anthropicToResponsesStream) start(message anthropic.Response) ([]protocol.SSEFrame, error) {
	if s.started {
	...
	return []protocol.SSEFrame{created, inProgress}, nil
}

func (s *anthropicToResponsesStream) startBlock(index int, content anthropic.Content) ([]protocol.SSEFrame, error) {
	if !s.started {
...
func (s *anthropicToResponsesStream) reasoningStart(block *anthropicToResponsesBlock) ([]protocol.SSEFrame, error) {
	...
	return []protocol.SSEFrame{added, part}, nil
}

func (s *anthropicToResponsesStream) textStart(block *anthropicToResponsesBlock) ([]protocol.SSEFrame, error) {
	added, err := makeStreamFrame("response.output_item.added", map[string]any{
		"type": "response.output_item.added", "output_index": len(s.response.Output), "item": block.item,
	})
	if err != nil {
...
func (s *anthropicToResponsesStream) toolStart(block *anthropicToResponsesBlock) ([]protocol.SSEFrame, error) {
...
func (s *anthropicToResponsesStream) pushBlockDelta(index int, deltaType, text, thinking, arguments string) ([]protocol.SSEFrame, error) {
...
func (s *anthropicToResponsesStream) stopBlock(index int) ([]protocol.SSEFrame, error) {
	block := s.blocks[index]
	if block == nil || block.closed {
...
func (s *anthropicToResponsesStream) finishReasoning(block *anthropicToResponsesBlock, outputIndex int) ([]protocol.SSEFrame, error) {
	...
	return []protocol.SSEFrame{textDone, partDone, itemDone}, nil
}

func (s *anthropicToResponsesStream) finishText(block *anthropicToResponsesBlock, outputIndex int) ([]protocol.SSEFrame, error) {
...
func (s *anthropicToResponsesStream) finishTool(block *anthropicToResponsesBlock, outputIndex int) ([]protocol.SSEFrame, error) {
	...
	return []protocol.SSEFrame{argumentsDone, itemDone}, nil
}

func responseOutputItemDone(item responses.OutputItem, outputIndex int) (protocol.SSEFrame, error) {
...
func (s *anthropicToResponsesStream) complete() ([]protocol.SSEFrame, error) {
	if !s.started {
...
func (s *anthropicToResponsesStream) fail(code, message string) ([]protocol.SSEFrame, error) {
	if code == "" {
		code = "upstream_error"
	}
	if message == "" {
...
func makeStreamFrame(event string, payload any) (protocol.SSEFrame, error) {
	body, err := json.Marshal(payload)
	if err != nil {
		return protocol.SSEFrame{}, protocolFailure(fmt.Errorf("encode %s event: %w", event, err))
	}
	return protocol.SSEFrame{Event: event, Data: body}, nil
}
