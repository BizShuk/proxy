...
func ChatToResponsesResponse(ctx context.Context, envelope protocol.ResponseEnvelope) (protocol.TransformResult, error) {
...
func ResponsesToChatResponse(ctx context.Context, envelope protocol.ResponseEnvelope) (protocol.TransformResult, error) {
	if err := ctx.Err(); err != nil {
		return protocol.TransformResult{}, err
	}
